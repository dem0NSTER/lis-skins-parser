...
def main(lis_skins_base_url):
    first = True
    while True:
        if first:
            print('[INFO] start furst time')
            first_elements(base_url=lis_skins_base_url)
            first = False
            time.sleep(4)
...
if __name__ == '__main__':
    main(lis_skins_base_url='https://lis-skins.ru/market/csgo/?category_id=19%2C11%2C32%2C3%2C7%2C28%2C10&price_from=40&price_to=100&is_without_souvenir=1')
